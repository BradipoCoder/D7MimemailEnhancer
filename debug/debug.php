...
<body>
    ...
    <pre><?php print htmlentities($message['themed_body']); ?></pre>

    <hr />
    <h3>Message</h3>
    <pre><?php print htmlentities(print_r($message, true)); ?></pre>

    <script type="text/javascript">
        var mme_debug = {
            'themed_body': <?php print json_encode($message["themed_body"]); ?>
        };
    </script>
